        ...
        <section className="testimonials">
            ...
            <div className="testimonials__cards container">
                <div className="testimonials__card">
                    <img className="testimonials__card__img" src={alex} alt="Alex"></img>
                ...
                <div className="testimonials__card">
                    <img className="testimonials__card__img" src={elisa} alt="Elisa"></img>
                ...
                <div className="testimonials__card">
                    <img className="testimonials__card__img" src={lara} alt="Lara"></img>
                    <h6 className="testimonials__card__name">Lara</h6>
                    <p className="testimonials__card__text">Easy to order online!</p>
                </div>
                <div className="testimonials__card">
                    <img className="testimonials__card__img" src={emma} alt="Emma"></img>
